...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 28 35" {...props}>
      ...
      <circle cx="14" cy="14" r="10" stroke="#B76011" strokeWidth="2"/>
      <circle cx="14" cy="14" r="9" fill="#EEA045"/>
      <path d="M14 9L15.7927 11.5325L18.7553 12.4549L16.9007 14.9425L16.9389 18.0451L14 17.05L11.0611 18.0451L11.0993 14.9425L9.24472 12.4549L12.2073 11.5325L14 9Z" fill="#CC5F30"/>
      <defs>
      <linearGradient id="paint0_linear" x1="5.5" y1="3" x2="23" y2="25.5" gradientUnits="userSpaceOnUse">
      <stop stopColor="#D38135"/>
      <stop offset="1" stopColor="#E6A443"/>
      </linearGradient>
      <linearGradient id="paint1_linear" x1="12" y1="9.5" x2="17.5" y2="18.5" gradientUnits="userSpaceOnUse">
      <stop stopColor="#CC5F30"/>
      <stop offset="1" stopColor="#BD6514"/>
      </linearGradient>
      </defs>
    </Svg>
  );
