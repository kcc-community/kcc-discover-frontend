...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 28 35" {...props}>
      ...
      <circle cx="14" cy="14" r="10" stroke="#FF922E" strokeWidth="2"/>
